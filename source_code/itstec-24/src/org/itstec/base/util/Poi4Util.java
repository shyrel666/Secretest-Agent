...
public class Poi4Util {
    ...
    private String checkCell(int row, int col){
        ...
        if(checkRow(row)&&checkCol(col)){
            try {
                ...
                //logger.debug("checkCellName dataCell:"+dataCell);
            } catch (NullPointerException e) {
                dataRow = sheet.createRow(row);
                dataCell = dataRow.createCell((short) col);
                //logger.debug("NullPointerException checkCellName dataCell:"+dataCell);
            }
            flag="3";
        }
        else{
    ...
    public String getCellNumberBy2ScaleValue(int row, int col) throws Exception{
        String strValue = "";
        String checkResult="0";
        checkResult=checkCell(row,col);
        if(checkResult.equals("3")){
            
            if(0==dataCell.getCellType().getCode()){
    ...
    public String getCellNumberValue(int row, int col) throws Exception{
        String strValue = "";
        String checkResult="0";
        checkResult=checkCell(row,col);
        if(checkResult.equals("3")){
    ...
    public String getCellDateValue(int row, int col) throws Exception{
        String strValue = "";
        String checkResult="0";
        checkResult=checkCell(row,col);
        if(checkResult.equals("3")){
            ...
            if(1==dataCell.getCellType().getCode()){
                //strValue = dataCell.getDateCellValue().toString();
    ...
    public String getCellDateValue(int row, int col, String str) throws Exception{
        String strValue = "";
        String checkResult="0";
        checkResult=checkCell(row,col);
        if(checkResult.equals("3")){
